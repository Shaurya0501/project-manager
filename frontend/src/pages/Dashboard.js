    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          <li>
            <Link to="/projects">
              <span className="icon" role="img" aria-label="projects">📁</span>
              Projects
            </Link>
          </li>
          <li>
            <Link to="/tasks">
              <span className="icon" role="img" aria-label="tasks">✅</span>
              Tasks
            </Link>
          </li>
          <li>
            <Link to="/team">
              <span className="icon" role="img" aria-label="team">👥</span>
              Team
            </Link>
          </li>
          <li>
      ...
      <div className="sidebar-footer">
        <button onClick={logout} className="signout-btn">
          <span className="icon" role="img" aria-label="sign out">↩️</span>
          Sign Out
        </button>
      </div>
    </aside>
